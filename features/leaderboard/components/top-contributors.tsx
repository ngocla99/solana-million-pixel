...
export function TopContributors() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      {/* #2 Silver */}
      <div className="relative group bg-zinc-900/40 border border-white/5 hover:border-white/10 rounded p-5 flex flex-col items-center gap-3 transition-all hover:-translate-y-1 md:mt-4">
        <div className="absolute top-3 left-3 text-xs font-mono text-zinc-500">
          #2
        </div>
      ...
      {/* #1 Gold */}
      <div className="relative group bg-linear-to-b from-yellow-500/10 to-transparent border border-yellow-500/20 rounded p-5 flex flex-col items-center gap-3 shadow-[0_0_30px_rgba(234,179,8,0.1)] scale-105 z-10">
        <div className="absolute -top-3">
          <CrownIcon className="text-yellow-400 drop-shadow-lg w-6 h-6" />
        </div>
        <div className="h-20 w-20 rounded-full p-[2px] bg-linear-to-b from-yellow-300 to-yellow-600 shadow-lg">
          <img
        ...
        <div className="text-center">
          ...
          <div className="text-xs font-mono text-yellow-500/80 mt-0.5">
            @king_dev
          </div>
        </div>
