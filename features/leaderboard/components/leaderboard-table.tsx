      ...
      <table className="w-full text-left border-collapse">
        ...
        <tbody className="divide-y divide-white/5 text-xs">
          ...
          <tr className="group hover:bg-white/5 transition-colors">
            ...
            <td className="px-6 py-4 text-right font-mono text-zinc-300">850</td>
            <td className="px-6 py-4 text-right font-mono text-zinc-500">0.85%</td>
            <td className="px-6 py-4 text-right font-mono text-white">21.4 SOL</td>
          </tr>
          {/* Row 5 */}
          <tr className="group hover:bg-white/5 transition-colors">
            ...
            <td className="px-6 py-4 text-right font-mono text-zinc-300">620</td>
            <td className="px-6 py-4 text-right font-mono text-zinc-500">0.62%</td>
            <td className="px-6 py-4 text-right font-mono text-white">18.2 SOL</td>
          </tr>
          {/* Row 6 */}
          <tr className="group hover:bg-white/5 transition-colors">
            ...
            <td className="px-6 py-4 text-right font-mono text-zinc-300">445</td>
            <td className="px-6 py-4 text-right font-mono text-zinc-500">0.44%</td>
            <td className="px-6 py-4 text-right font-mono text-white">12.9 SOL</td>
          </tr>
          {/* Row 7 */}
          <tr className="group hover:bg-white/5 transition-colors">
            ...
            <td className="px-6 py-4 text-right font-mono text-zinc-300">320</td>
            <td className="px-6 py-4 text-right font-mono text-zinc-500">0.32%</td>
            <td className="px-6 py-4 text-right font-mono text-white">8.5 SOL</td>
          </tr>
          {/* Row 8 */}
          <tr className="group hover:bg-white/5 transition-colors">
            ...
            <td className="px-6 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-zinc-400 font-medium italic">Anonymous</div>
                  <div className="text-[10px] text-zinc-500">1a...b2c</div>
                </div>
              </div>
            </td>
            <td className="px-6 py-4 text-right font-mono text-zinc-300">210</td>
            <td className="px-6 py-4 text-right font-mono text-zinc-500">0.21%</td>
            <td className="px-6 py-4 text-right font-mono text-white">5.1 SOL</td>
          </tr>
        </tbody>
      </table>
